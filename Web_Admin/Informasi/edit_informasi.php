...
<div class="container text-center">
    ...
    <form method="post" action="ubah_informasi.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="ttl">ubah Tanggal Lahir</label>
            <input type="date" class="form-control" id="ttl" name="ttl" min="1950-01-01" max="2007-12-31" value="<?php echo $row['ttl']; ?>" required>
        </div>
        <div class="form-group">
